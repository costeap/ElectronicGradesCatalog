...
public class ProfesorDto {
    ...
    private List<CursDto> listaCursuri = new ArrayList<CursDto>();

    public ProfesorDto(Long id, String cnp, String nume, String email, String numarTel, String username, String parola, Boolean admin, List<CursDto> listaCursuri) {
        this.id=id;
        this.nume = nume;
        this.cnp = cnp;
        this.email = email;
